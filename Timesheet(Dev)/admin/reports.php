...
<html>
	<head>
		...
		<title>Cape Henry Timesheet - Administrator - Reports</title>
        ...
        <script src="../javascript/reports_functions.js" type="text/javascript"></script>
	</head>
	...
	<body>
    	<div id="page_container">
            ...
            <ul id="options">
                ...
                <li><button class="selected" type="submit" onclick="location.href='reports.php'">Reports</button></li>
            </ul>
            ...
            <div id="content">
            	<div id="reports">
                    <div id="emp_report_form">
                    	<a href="#" id="emp_report_link" onclick="view_emp_report_form()">Employee Report Form</a>
                    </div>
                    
                    <div id="job_report_form">
                    	<a href="#" id="job_report_link" onclick="view_job_report_form()">Job Report Form</a>
                    </div>
                </div>  
            </div>
