...
<html>
	<head>
		...
		<title>Cape Henry Timesheet - Administrator - Holidays</title>
		...
		<script type="text/javascript" src="../javascript/holiday_functions.js"></script>
	</head>
    	...
    	<div id="page_container">
            ...
            <p class="admin_greet_user">Welcome <?php echo $user_info['first_name']; ?>!</p>
             <ul id="options">
                ...
                <li><button class="selected" type="submit" onclick="location.href='holidays.php'">Holidays</button></li>
            ...
            <div id="content">
            	<button id="new_holiday" type="submit" onclick="new_holiday()">+ Add</button>
				<div id="holidays"></div>
            </div>
