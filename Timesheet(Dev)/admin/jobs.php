...
<html>
	<head>
		...
		<title>Cape Henry Timesheet - Administrator - Jobs</title>
		...
		<script type="text/javascript" src="../javascript/job_functions.js"></script>
	</head>
    	...
    	<div id="page_container">
            ...
            <p class="admin_greet_user">Welcome <?php echo $user_info['first_name']; ?>!</p>
             <ul id="options">
                ...
                <li><button class="selected" type="submit" onclick="location.href='jobs.php'">Jobs</button></li>
            ...
            <div id="content">
            	...
            	<button id="new_job" type="submit" onclick="new_job()">+ Add</button>
            	<div id="jobs"></div>
