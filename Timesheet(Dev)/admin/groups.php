...
<html>
	<head>
		...
		<title>Cape Henry Timesheet - Administrator - Groups</title>
		...
		<script src="../javascript/group_functions.js" type="text/javascript"></script>
	</head>
	...
	<body>
    	<div id="page_container">
            ...
            <div id="content">
            	...
            	<button id="new_group" type="submit" onclick="new_group()">+ Add</button>
            	<div id="groups"></div>
